...
public class RepositoryTodoServiceTest {
	...
	public void deleteById_TodoEntryFound_ShouldDeleteTodoEntryAndReturnIt()
		...
		Todo model = new TodoBuilder().id(ID).description(DESCRIPTION)
				.title(TITLE).build();
	...
	public void deleteById_TodoEntryNotFound_ShouldThrowException()
			throws TodoNotFoundException {
	...
	@Test
	public void update_TodoEntryFound_ShouldUpdateTodoEntry()
			throws TodoNotFoundException {
		TodoDTO dto = new TodoDTOBuilder().id(ID)
				.description(DESCRIPTION_UPDATED).title(TITLE_UPDATED).build();
