...
// AuthenticationProvider {
{
	...
	// UserDetailsServiceImpl_hib service;
	@Autowired
	UserService service;

	// UserDetailsServiceImpl_db service;
	...
	public Authentication authenticate(Authentication authentication)
		...
		if (obj instanceof CustomWebAuthenticationDetail) {
			CustomWebAuthenticationDetail customwebad = (CustomWebAuthenticationDetail) obj;
			System.out.println(customwebad.getReferer());
		}
